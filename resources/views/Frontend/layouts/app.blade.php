<!doctype html>
<html lang="en">
   <!-- Mirrored from shiphaw-xpress.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Dec 2022 05:57:41 GMT -->
   <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      <meta name="theme-color" content="#fed300" />
      <title>Cross-Border Cargo LOGISTICS
         .com| Logicstic Shipping Company
      </title>
      <!-- FAVICON FILES -->
   ...
   <body>
      ...
      <aside class="side-widget">
         <div class="inner">
            <!-- <div class="logo"> <a href="index-2.html"><img src="swiftcargotransit.com/logo4.png" alt="Image" width="150px"></a> </div> -->
            <!-- end logo -->
            <div class="hide-mobile">
               <p>Take the complexity out of customs Freight Solutions with customs brokerage services</p>
               <figure class="gallery"><a href="images/recent-news01.jpg" data-fancybox><img src="{{ asset('assets/images/recent-news01.jpg') }}" alt="Image"></a><a href="images/recent-news02.jpg" data-fancybox><img src="{{ asset('assets/images/recent-news02.jpg') }}" alt="Image"></a></figure>
               <h6 class="widget-title">CONTACT INFO</h6>
               <address class="address">
                  <!-- <p>+1 (850) 344 0 66<br> -->
                  <a href="#">support@crossbordercargologistics.com</a></p>
               </address>
            ...
            <!-- end show-mobile -->
            <small>© 2023 Cross-Border Cargo LOGISTICS
      ...
      <div class="topbar">
         <div class="container">
            ...
            <!-- end phone -->
            <div class="email"> Email: <a href="#">support@crossbordercargologistics.com</a> </div>
            <!-- end email -->
      ...
      <nav class="navbar">
         <div class="container">
            <div class="inner">
               <!-- <div class="logo"> <a href="index.php"> <img src="swiftcargotransit.com/logo4.png" width="100px" alt="Image"> </a> </div> -->
               <!-- end logo -->
               <!-- end custom-menu -->
               <div class="site-menu">
                  <ul>
                     ...
                     <li><a href="{{ route('About') }}">About</a></li>
                     <li><a href="{{ route('Contact') }}">Contact</a></li>
                     <!-- <li><a href="http://track.swiftcargotransit.com/">Track</a></li> -->
                     <!-- <li><a href="tracking_files/payment_form.php">Make Payment</a></li> -->
                  </ul>
               </div>
               <!-- end site-menu -->
      ...
      <footer class="footer">
         <div class="container">
            <div class="row">
               ...
               <!-- end col-4 -->
               <div class="col-12">
                  <div class="footer-bottom"> <span>© 2025 Cross-Border Cargo LOGISTICS| Logicstic Shipping Company</span> </div>
                  <!-- end footer-bottom -->
               </div>
               <!-- end col-12 -->
            </div>
