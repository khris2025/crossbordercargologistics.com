...
<section class="content-section">
   <div class="container">
      <div class="row">
         ...
         <!-- end col-12 -->
         <div class="col-lg-6">
            <p>Cross-Border Cargo LOGISTICS.com, we believe the supplier-vendor relationship to be an
         ...
         <div class="col-lg-3 col-md-6">
            <div class="service-box">
               <div class="inner">
                  ...
                  <figure>
                     <img src="{{ asset('assets/images/icon04.png') }}" alt="Image">
                  </figure>
               </div>
               <!-- end inner -->
            </div>
         ...
         <div class="col-lg-3 col-md-6">
            <div class="service-box">
               <div class="inner">
                  ...
                  <figure>
                     <img src="{{ asset('assets/images/icon05.png') }}" alt="Image">
                  </figure>
               </div>
               <!-- end inner -->
            </div>
         ...
         <div class="col-lg-3 col-md-6">
            <div class="service-box">
               <div class="inner">
                  ...
                  <figure>
                     <img src="{{ asset('assets/images/icon06.png') }}" alt="Image">
                  </figure>
               </div>
               <!-- end inner -->
            </div>
         ...
         <div class="col-lg-3 col-md-6">
            <div class="service-box">
               <div class="inner">
                  ...
                  <figure>
                     <img src="{{ asset('assets/images/icon07.png') }}" alt="Image">
                  </figure>
               </div>
               <!-- end inner -->
            </div>
      ...
      <div class="row align-items-center no-gutters">
         <div class="col-lg-6">
            <div class="side-content">
               ...
               <p>Cross-Border Cargo LOGISTICS.com, we’re passionate about helping our
...
<section class="content-section no-spacing" data-background="#ffffff">
   <div class="container">
      <div class="row align-items-center no-gutters">
         <div class="col-lg-6">
            <figure class="side-image full-left"> <img src="{{ asset('assets/images/side-image02.jpg') }}" alt="Image"> </figure>
         </div>
         <!-- end col-6 -->
         <div class="col-lg-6">
